...
runners.forEach(function(element, index) {
    fullName[index] = `${element.first_name} ${element.last_name}`
  });
...
ticketPriceTotal = runners.reduce(function(ticketPriceTotal, element) {
    return ticketPriceTotal + element.donation;
}, 0)
